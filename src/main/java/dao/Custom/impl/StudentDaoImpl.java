...
public class StudentDaoImpl implements StudentDao {
    ...
    public boolean save(StudentEntity studentEntity) throws Exception {
        return CrudUtil.executeUpdate("INSERT INTO Student (student_id, name, reg_number, gender, dob, email, contact, course_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
    ...
    public boolean update(StudentEntity studentEntity) throws Exception {
        return CrudUtil.executeUpdate("UPDATE Student SET name=?, reg_number=?, gender=?, dob=?, email=?, contact=?, course_id=? WHERE student_id=?",
                studentEntity.getName(),
                studentEntity.getRegNumber(),
                studentEntity.getGender(),
                studentEntity.getDob(),
