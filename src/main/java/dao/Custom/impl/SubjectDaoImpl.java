...
public class SubjectDaoImpl implements SubjectDao {
    ...
    public boolean save(SubjectEntity subjectEntity) throws Exception {
        return CrudUtil.executeUpdate("INSERT INTO Subject(subject_id, name, credit_hours, course_id) VALUES (?, ?, ?, ?)",
    ...
    public boolean update(SubjectEntity subjectEntity) throws Exception {
        return CrudUtil.executeUpdate( "UPDATE Subject SET name = ?, credit_hours = ?, course_id = ? WHERE subject_id = ?",
                subjectEntity.getSubjectName(),
                subjectEntity.getCreditHours(),
                subjectEntity.getCourseId(),
                subjectEntity.getSubjectId());
    ...
    public boolean delete(String s) throws Exception {
        return CrudUtil.executeUpdate("DELETE FROM Subject WHERE subject_id = ?",s);
    }
